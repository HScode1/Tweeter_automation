...
const StatCard = ({ icon: Icon, value, label, delay }) => {
  return (
    ...
    >
      <div className="p-3 rounded-lg bg-black/80 border border-purple-500/30 group-hover:border-[#a2d45e]/30 transition-colors duration-300" aria-hidden="true">
...
const StatsSection = () => {
  return (
    <section className="py-24 px-4 bg-gradient-to-b from-black to-gray-900 text-white relative overflow-hidden" aria-label="Statistiques">
      {/* Decorative Blobs - Using CSS instead of large divs */}
